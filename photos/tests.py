...
from .models import Image,Title,Location
# Create your tests here.
class ImageTestClass(TestCase):
    ...
    def test_update_method(self):
        self.tony = Image(name = 'james', description = 'picture of tony')
        self.tony.save_image()
        self.tony = Image(name = 'james', description = 'picture of tony')        
        self.tony.update_image(name = 'james')
        self.tony.save_image()
        images = Image.objects.filter(name = 'james')
